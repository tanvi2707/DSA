def additionmat(r,c,m,m1):
	print("Addition of two Matrices by using List Comprehension")
...
def subtractionmat(r,c,m,m1):
	print("Subtraction of two Matrices by using List Comprehension")
	print([[(m[i][j]-m1[i][j]) for j in range(c)] for i in range(r)])
...
def transposemat(r,c,m):
	print("Transpose of two Matrices by using List Comprehension")
	print([[print(m[j][i],end=" ") for j in range(c)] for i in range(r)])
